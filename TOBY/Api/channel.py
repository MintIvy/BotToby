...
class Channel:
    ...
    LA = "Mozilla/5.0 (X11; CrOS x86_64 9765.85.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.123 Safari/537.36"
    ...
    def login(self):
        result = self.client.issueChannelToken("1545081241")
